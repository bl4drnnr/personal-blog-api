interface EmailBaseTemplateData {
  title: string;
  content: string;
}

export const baseEmailTemplate = ({ title, content }: EmailBaseTemplateData) => {
                                                                                        ...
                                                                                        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#fff;" height="100%" valign="top" bgcolor="#fff" role="module-content">
                                                                                            <div>
                                                                                                <div style="font-family: inherit; text-align: center">
                                                                                                    <span style="color: #000; font-size: 24px; font-weight: bold;">${title}</span>
                                                                                                </div>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
